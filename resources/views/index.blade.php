		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
                    <form id="loginForm" class="form-horizontal m-t-20" action="/landing" method="post">
                        @csrf
                        <div class="form-group ml-5 mr-5">
                            <div class="input-group-append">
                                <input class="form-control" id="username" name="usr" type="text" required="" placeholder="Username" value="" />
                            </div>
                        </div>

                        <div class="form-group ml-5 mr-5">
                            <div class="input-group-append">
                                <input class="form-control" id="password" name="pwd"  type="password" required="" placeholder="Password" value=""/>
                            </div>
                        </div>
                        <div class="form-group text-center m-t-30 ml-5 mr-5">
                            <div class="col-xs-12">
                                <button type="submit" class="btn btn-custom btn-bordred btn-block waves-effect waves-light" id="login">Log In</button>
                            </div>
                        </div>
                ...
                <div class="form-group m-t-30 m-b-0">
                    <div class="col-sm-12">
                        <a href="/reset/request" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                    </div>
                </div>
